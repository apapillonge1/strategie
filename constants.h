...
constexpr std::string_view playground_image_resource = "/home/pi/ressources/images/map.svg";
...
//constexpr std::string_view robot_image_resource = "/home/pi/ressources/images/robot_ouvert.png";
constexpr std::string_view robot_image_resource = "/home/pi/ressources/images/robot_ferme.png";
constexpr double robot_scaling = 1; // how many times you need to multiply the img size to have 1pixel =  1mm in real life

constexpr std::string_view fragile_plant_ressource = "/home/pi/ressources/images/plants/fragile_plant.svg";
constexpr std::string_view fragile_plant_pot_ressource = "/home/pi/ressources/images/plants/fragile_plant_pot.svg";

constexpr std::string_view regular_plant_ressource = "/home/pi/ressources/images/plants/regular_plant.svg";
constexpr std::string_view regular_plant_pot_ressource = "/home/pi/ressources/images/plants/regular_plant_pot.svg";

        // OLD PATHS TO RESSOURCES FILES
